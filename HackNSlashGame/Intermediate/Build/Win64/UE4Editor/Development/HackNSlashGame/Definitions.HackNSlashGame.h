...
#define ORIGINAL_FILE_NAME "UE4Editor-HackNSlashGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME HackNSlashGame
...
#define HACKNSLASHGAME_API DLLEXPORT
